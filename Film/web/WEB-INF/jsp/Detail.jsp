...
<header class="ht-header">
	<div class="container">
	    ...
	    <form method="POST">
			...
			<input style="float: left; width: 18%; margin-top: 1%; border-radius: 2px;" class="form-control" type="submit" value="Rechercher">
	    </form>
	</div>
</header>
<!-- END | Header -->
		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="../../resources/images/uploads/series-img.jpg" alt="">
				</div>
			</div>
