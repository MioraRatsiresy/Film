...
;(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['web/resources/js/jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('web/resources/js/jquery'));
    } else {
        factory(jQuery);
    }
